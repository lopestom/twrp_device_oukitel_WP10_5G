...
DEVICE_PATH := device/oukitel/WP10
...
# Assert
TARGET_OTA_ASSERT_DEVICE := WP10_EEA,WP10
...
BOARD_VENDORIMAGE_PARTITION_SIZE := 0x26598000
...
BOARD_OUKITEL_DYNAMIC_PARTITIONS_SIZE := 5368709120
BOARD_OUKITEL_DYNAMIC_PARTITIONS_PARTITION_LIST := product vendor system
...
BOARD_DTBO_OFFSET := 0x0113d000 # 25927680 = # 0x18BA000
...
#PLATFORM_SECURITY_PATCH := 2099-12-31 ## 2020-12-05
#PLATFORM_VERSION := 16.1.0 ## 10
#VENDOR_SECURITY_PATCH := 2099-12-31 ## 2020-12-05
...
TW_DEVICE_VERSION := Oukitel WP10_5G_EEA_V10_20201216 by lopestom
